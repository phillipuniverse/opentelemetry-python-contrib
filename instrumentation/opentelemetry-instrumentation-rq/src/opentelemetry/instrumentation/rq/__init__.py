...
"""
Instrument `rq`_ to trace RQ applications.
...
.. code::
    ...
    docker run -p 6379:6379 rabbitmq
...
from opentelemetry.instrumentation.rq.version import __version__
